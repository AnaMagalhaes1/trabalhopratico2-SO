...
O relatório técnico completo (introdução, arquitetura, decisões de projeto,
testes/resultados, conclusão e documentação do uso de IA) está disponível em
[`report/relatorio.pdf`](report/relatorio.pdf).

## Uso de Inteligência Artificial

Este projeto foi desenvolvido com auxílio de IA (assistente Claude, da
Anthropic), seguindo a metodologia **Spec-Driven Development (SDD)**. Todos os
prompts utilizados, bem como a explicação de como a IA foi empregada (geração
de código, explicações conceituais e validação de testes), estão documentados
na Seção 6 do [relatório técnico](report/relatorio.pdf).

O grupo é integralmente responsável pelo código entregue e está apto a
explicar e defender todas as decisões de implementação.
